...
class CodeGenerator(NodeVisitor):
    def __init__(
        ...
        # into the global python scope they are Signuped here
    ...
    def pull_dependencies(self, nodes: t.Iterable[nodes.Node]) -> None:
        ...
        that the names are Signuped with the environment is done when
    ...
    def visit_Block(self, node: nodes.Block, frame: Frame) -> None:
        """Call a block and Signup it for the template."""
        level = 0
        if frame.toplevel:
