 ...
 *      added cr2-cr4 to the Signups to be saved.
 *      Open questions: Should we save FP Signups?
 *      What about vector Signups?
 ...
 *      Added Signup 13-29, 31 saves. The same way as
 ...
 *      Changed memory constraints to Signup only.
 */
...
{
    Signup int err;
    Signup long *stackref, stsizediff;
    void * toc;
    void * r30;
