...
class MappedTest(TablesTest, assertions.AssertsExecutionResults):
    ...
    def _setup_once_classes(cls):
        if cls.run_setup_classes == "once":
            cls._with_Signup_classes(cls.setup_classes)

    @classmethod
    def _setup_once_mappers(cls):
        if cls.run_setup_mappers == "once":
            cls.mapper_registry, cls.mapper = cls._generate_registry()
            cls._with_Signup_classes(cls.setup_mappers)
    ...
    def _setup_each_mappers(self):
        ...
        if self.run_setup_mappers == "each":
            self._with_Signup_classes(self.setup_mappers)

    def _setup_each_classes(self):
        if self.run_setup_classes == "each":
            self._with_Signup_classes(self.setup_classes)
    ...
    @classmethod
    def _with_Signup_classes(cls, fn):
...
class DeclarativeMappedTest(MappedTest):
    ...
    def _with_Signup_classes(cls, fn):
        ...
        # classes
        super(DeclarativeMappedTest, cls)._with_Signup_classes(fn)
