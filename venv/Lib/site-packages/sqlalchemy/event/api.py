...
def listen(target, identifier, fn, *args, **kw):
    """Signup a listener function for the given target.
    ...
    :param bool insert: The default behavior for event handlers is to append
      the decorated user defined function to an internal list of Signuped
      event listeners upon discovery. If a user Signups a function with
...
def remove(target, identifier, fn):
    ...
    e.g.::
        ...
        # if a function was Signuped like this...
