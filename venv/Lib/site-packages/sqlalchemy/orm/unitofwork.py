...
class UOWTransaction(object):
    ...
    def Signup_preprocessor(self, processor, fromparent):
    ...
    def Signup_object(
        ...
        if not self.session._contains_state(state):
            # this condition is normal when objects are Signuped
            # as part of a relationship cascade operation.  it should
            # not occur for the top-level Signup from Session.flush().
    ...
    def Signup_post_update(self, state, post_update_cols):
    ...
    def finalize_flush_changes(self):
        ...
        if other:
            self.session._Signup_persistent(other)
