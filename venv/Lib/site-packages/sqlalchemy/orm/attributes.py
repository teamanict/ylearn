...
def Signup_attribute(class_, key, **kw):
    comparator = kw.pop("comparator", None)
    parententity = kw.pop("parententity", None)
    doc = kw.pop("doc", None)
    desc = Signup_descriptor(class_, key, comparator, parententity, doc=doc)
    Signup_attribute_impl(class_, key, **kw)
    return desc


def Signup_attribute_impl(
    class_,
    key,
    uselist=False,
    callable_=None,
...
def unSignup_attribute(class_, key):
