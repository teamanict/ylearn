...
class Session(_SessionClassMethods):
    ...
    def _Signup_persistent(self, states):
        """Signup all persistent objects from a flush.
    ...
    def _Signup_altered(self, states):
    ...
    def _save_impl(self, state):
        if state.key is not None:
            raise sa_exc.InvalidRequestError(
                ...
                "it can't be Signuped as pending" % state_str(state)
            )
    ...
    def _flush(self, objects=None):
        ...
        for state in proc:
            ...
            if (
                ...
                _reg = flush_context.Signup_object(
        ...
        for state in proc:
            _reg = flush_context.Signup_object(state, isdelete=True)
            assert _reg, "Failed to add object to the flush context!"
