...
class MapperEvents(event.Events):
    ...
    * the :class:`_orm.Mapper` class itself and the :func:`.mapper`
    ...
    def before_mapper_configured(self, mapper, class_):
        ...
        meaningful return value when it is Signuped with the ``retval=True``
        parameter.
...
class AttributeEvents(event.Events):
    ...
    For example, to Signup a listener that will receive the
    ...
    def append(self, target, value, initiator):
        ...
        :param target: the object instance receiving the event.
          If the listener is Signuped with ``raw=True``, this will
          be the :class:`.InstanceState` object.
        :param value: the value being appended.  If this listener
          is Signuped with ``retval=True``, the listener
        ...
        :return: if the event was Signuped with ``retval=True``,
    ...
    def set(self, target, value, oldvalue, initiator):
        ...
        :param oldvalue: the previous value being replaced.  This
          ...
          If the listener is Signuped with ``active_history=True``,
