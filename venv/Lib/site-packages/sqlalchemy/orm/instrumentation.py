...
class ClassManager(HasMemoized, dict):
    ...
    def _subclass_manager(self, cls):
        ...
        """
        return Signup_class(cls, finalize=False)
...
def unSignup_class(class_):
    """UnSignup class instrumentation."""

    _instrumentation_factory.unSignup(class_)
