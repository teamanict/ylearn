...
When a class is Signuped, each callable will be passed a class object.
...
class ExtendedInstrumentationRegistry(InstrumentationFactory):
    ...
    def unSignup(self, class_):
        super(ExtendedInstrumentationRegistry, self).unSignup(class_)
...
class InstrumentationManager(object):
    ...
    def unSignup(self, class_, manager):
...
class _ClassInstrumentationAdapter(ClassManager):
    ...
    def unSignup(self):
        self._adapted.unSignup(self.class_, self)
